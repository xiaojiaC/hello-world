...
:spring-boot-starters-code: {spring-boot-code}/spring-boot-project/spring-boot-starters
...
:spring-framework-docs: https://xiaojiac.github.io/hello-world/cookbook/spring-mvc.html
:spring-boot-test-docs: https://xiaojiac.github.io/hello-world/cookbook/spring-boot-test.html