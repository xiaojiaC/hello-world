...
[[mvc-servlet]]
== DispatcherServlet
[.small]#<<spring-webflux.adoc#webflux-dispatcher-handler,WebFlux>>#
...
=== 特殊Bean类型
[.small]#<<spring-webflux.adoc#webflux-special-bean-types,WebFlux>>#
...
[[mvc-servlet-config]]
=== Web MVC配置
[.small]#<<spring-webflux.adoc#webflux-framework-config,WebFlux>>#
...
=== 处理过程
[.small]#<<spring-webflux.adoc#webflux-dispatcher-handler-sequence,WebFlux>>#
...
=== 异常
[.small]#<<spring-webflux.adoc#webflux-dispatcher-exceptions,WebFlux>>#
...
[[mvc-viewresolver]]
=== 视图解析
[.small]#<<spring-webflux.adoc#webflux-viewresolution,WebFlux>>#
...
==== 处理
[.small]#<<spring-webflux.adoc#webflux-viewresolution-handling,WebFlux>>#
...
==== 重定向
[.small]#<<spring-webflux.adoc#webflux-redirecting-redirect-prefix,WebFlux>>#
...
==== 内容协商
[.small]#<<spring-webflux.adoc#webflux-multiple-representations,WebFlux>>#
...
[[mvc-multipart]]
=== Multipart解析器
[.small]#<<spring-webflux.adoc#webflux-multipart,WebFlux>>#
...
[[mvc-logging]]
=== 日志
[.small]#<<spring-webflux.adoc#webflux-logging,WebFlux>>#
...
==== 敏感数据
[.small]#<<spring-webflux.adoc#webflux-logging-sensitive-data,WebFlux>>#
...
[[filters]]
== 过滤器
[.small]#<<spring-webflux.adoc#webflux-filters,WebFlux>>#
...
[[filters-forwarded-headers]]
=== Forwarded请求头
[.small]#<<spring-webflux.adoc#webflux-forwarded-headers,WebFlux>>#
...
[[filters-cors]]
=== CORS
[.small]#<<spring-webflux.adoc#webflux-filters-cors,WebFlux>>#
...
[[mvc-controller]]
== 带注解的控制器
[.small]#<<spring-webflux.adoc#webflux-controller,WebFlux>>#
...
[[mvc-ann-controller]]
=== 声明
[.small]#<<spring-webflux.adoc#webflux-ann-controller,WebFlux>>#
...
=== 请求映射
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping,WebFlux>>#
...
==== URI模式
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-uri-templates,WebFlux>>#
...
==== 模式比较
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-pattern-comparison,WebFlux>>#
...
==== 可消费的媒体类型
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-consumes,WebFlux>>#
...
==== 可生产的媒体类型
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-produces,WebFlux>>#
...
==== 请求参数，请求头
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-params-and-headers,WebFlux>>#
...
==== HTTP HEAD, OPTIONS
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-head-options,WebFlux>>#
...
==== 自定义注解
[.small]#<<spring-webflux.adoc#mvc-ann-requestmapping-head-options,WebFlux>>#
...
==== 显式注册
[.small]#<<spring-webflux.adoc#webflux-ann-requestmapping-registration,WebFlux>>#
...
[[mvc-ann-methods]]
=== 处理器方法
[.small]#<<spring-webflux.adoc#webflux-ann-methods,WebFlux>>#

`@RequestMapping` 处理器方法具有灵活的签名，可以从一系列受支持的控制器方法参数和返回值中进行选择。

[[mvc-ann-arguments]]
==== 方法参数
[.small]#<<spring-webflux.adoc#webflux-ann-arguments,WebFlux>>#
...
==== 返回值
[.small]#<<spring-webflux.adoc#webflux-ann-return-types,WebFlux>>#
...
==== 类型转换
[.small]#<<spring-webflux.adoc#webflux-ann-typeconversion,WebFlux>>#
...
==== 矩阵变量
[.small]#<<spring-webflux.adoc#webflux-ann-matrix-variables,WebFlux>>#
...
==== `@RequestParam`
[.small]#<<spring-webflux.adoc#webflux-ann-requestparam,WebFlux>>#
...
==== `@RequestHeader`
[.small]#<<spring-webflux.adoc#webflux-ann-requestheader,WebFlux>>#
...
[[mvc-ann-cookievalue]]
==== `@CookieValue`
[.small]#<<spring-webflux.adoc#webflux-ann-cookievalue,WebFlux>>#
...
==== `@ModelAttribute`
[.small]#<<spring-webflux.adoc#webflux-ann-modelattrib-method-args,WebFlux>>#
...
==== `@SessionAttributes`
[.small]#<<spring-webflux.adoc#webflux-ann-sessionattributes,WebFlux>>#
...
==== `@SessionAttribute`
[.small]#<<spring-webflux.adoc#webflux-ann-sessionattribute,WebFlux>>#
...
==== `@RequestAttribute`
[.small]#<<spring-webflux.adoc#webflux-ann-requestattrib,WebFlux>>#
...
[[mvc-multipart-forms]]
==== Multipart
[.small]#<<spring-webflux.adoc#webflux-multipart-forms,WebFlux>>#
...
[[mvc-ann-requestbody]]
==== `@RequestBody`
[.small]#<<spring-webflux.adoc#webflux-ann-requestbody,WebFlux>>#
...
[[mvc-ann-httpentity]]
==== HttpEntity
[.small]#<<spring-webflux.adoc#webflux-ann-httpentity,WebFlux>>#
...
==== `@ResponseBody`
[.small]#<<spring-webflux.adoc#webflux-ann-responsebody,WebFlux>>#
...
==== ResponseEntity
[.small]#<<spring-webflux.adoc#webflux-ann-responseentity,WebFlux>>#
...
[[mvc-ann-jsonview]]
===== JSON视图
[.small]#<<spring-webflux.adoc#webflux-ann-jsonview,WebFlux>>#
...
=== 模型
[.small]#<<spring-webflux.adoc#webflux-ann-modelattrib-methods,WebFlux>>#
...
[[mvc-ann-initbinder]]
=== `DataBinder`
[.small]#<<spring-webflux.adoc#webflux-ann-initbinder,WebFlux>>#
...
=== 异常
[.small]#<<spring-webflux.adoc#webflux-ann-controller-exceptions,WebFlux>>#
...
==== REST API异常
[.small]#<<spring-webflux.adoc#webflux-ann-rest-exceptions,WebFlux>>#
...
=== 控制器通知
[.small]#<<spring-webflux.adoc#webflux-ann-controller-advice,WebFlux>>#
...
[[webmvc-fn]]
== 函数式端点
[.small]#<<spring-webflux.adoc#webflux-fn,WebFlux>>#
...
[[webmvc-fn-overview]]
=== 总览
[.small]#<<spring-webflux.adoc#webflux-fn-overview,WebFlux>>#
...
=== `HandlerFunction`
[.small]#<<spring-webflux.adoc#webflux-fn-handler-functions,WebFlux>>#
...
=== `RouterFunction`
[.small]#<<spring-webflux.adoc#webflux-fn-router-functions,WebFlux>>#
...
[[webmvc-fn-running]]
=== 运行服务器
[.small]#<<spring-webflux.adoc#webflux-fn-running,WebFlux>>#
...
=== 过滤处理程序函数
[.small]#<<spring-webflux.adoc#webflux-fn-handler-filter-function,WebFlux>>#
...
[[mvc-uri-building]]
== URI链接
[.small]#<<spring-webflux.adoc#webflux-uri-building,WebFlux>>#

本部分介绍了Spring框架中可用于URI的各种选项。

include::web-uris.adoc[leveloffset=+1]
...
=== HTTP流
[.small]#<<spring-webflux.adoc#webflux-codecs-streaming,WebFlux>>#
...
[[mvc-web-security]]
== Web安全
[.small]#<<spring-webflux.adoc#webflux-web-security,WebFlux>>#
...
[[mvc-caching]]
== HTTP缓存
[.small]#<<spring-webflux.adoc#webflux-caching,WebFlux>>#
...
=== `CacheControl`
[.small]#<<spring-webflux.adoc#webflux-caching-cachecontrol,WebFlux>>#
...
[[mvc-caching-etag-lastmodified]]
=== 控制器
[.small]#<<spring-webflux.adoc#webflux-caching-etag-lastmodified,WebFlux>>#
...
[[mvc-caching-static-resources]]
=== 静态资源
[.small]#<<spring-webflux.adoc#webflux-caching-static-resources,WebFlux>>#
...
[[mvc-config]]
== MVC配置
[.small]#<<spring-webflux.adoc#webflux-config,WebFlux>>#
...
[[mvc-config-enable]]
=== 启用MVC配置
[.small]#<<spring-webflux.adoc#webflux-config-enable,WebFlux>>#
...
=== MVC配置API
[.small]#<<spring-webflux.adoc#webflux-config-customize,WebFlux>>#
...
=== 类型转换
[.small]#<<spring-webflux.adoc#webflux-config-conversion,WebFlux>>#
...
=== 验证
[.small]#<<spring-webflux.adoc#webflux-config-validation,WebFlux>>#
...
=== 内容类型
[.small]#<<spring-webflux.adoc#webflux-config-content-negotiation,WebFlux>>#
...
=== 消息转换器
[.small]#<<spring-webflux.adoc#webflux-config-message-codecs,WebFlux>>#
...
=== 视图解析器
[.small]#<<spring-webflux.adoc#webflux-config-view-resolvers,WebFlux>>#
...
=== 静态资源
[.small]#<<spring-webflux.adoc#webflux-config-static-resources,WebFlux>>#
...
=== 路径匹配
[.small]#<<spring-webflux.adoc#webflux-config-path-matching,WebFlux>>#
...
=== 高级Java配置
[.small]#<<spring-webflux.adoc#webflux-config-advanced-java,WebFlux>>#
...
[[mvc-http2]]
== HTTP/2
[.small]#<<spring-webflux.adoc#webflux-http2,WebFlux>>#
